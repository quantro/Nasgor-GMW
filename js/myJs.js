    ...
    onSelectRow: function (ids, stat) {
        if (ids == null) {
            ...
            if (jQuery("#fGroup").jqGrid('getGridParam', 'records') > 0) {
                jQuery("#fGroup").jqGrid('setGridParam', {
            ...
            //console.log(ret);
            jQuery("#fGroup").jqGrid('setGridParam', {
                url: siteUrl + "?option=com_rs&l=l&t=fields&opt=group&id=" + ids,
                page: 1
            });
...
jQuery("#fType").jqGrid('navGrid', '#fType_pager', {
    add: false,
    edit: false,
    del: false
});
